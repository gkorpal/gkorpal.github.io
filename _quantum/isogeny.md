...
**Update (Jul 30, 2022):** SIKE broken by Wouter Castryck and Thomas Decru. The [SageMath implementation](https://github.com/jack4818/Castryck-Decru-SageMath) of this attack recovers the private key in few minutes.
...
5. G. Frey and T. Shaska (2018), [Curves, Jacobians, and Cryptography](https://arxiv.org/abs/1807.05270)
6. S. Arpin (Boulder 2019) , [A Survey of Literature on Supersingular Isogeny Graphs](http://math.colorado.edu/~saar7867/SupersingularIsogenyLiterature.pdf)
7. \*C. Costello (2019), [Supersingular isogeny key exchange for beginners](https://eprint.iacr.org/2019/1321) (Bonus: [video](https://www.microsoft.com/en-us/research/video/post-quantum-cryptography-supersingular-isogenies-for-beginners/))
8. K. Lauter and J. Sotáková (2021), [Supersingular Isogeny Graphs in Cryptography](https://jana-sotakova.github.io/PCMI.html) (Bonus: [PCMI webpage](https://www.ias.edu/pcmi/2021-graduate-summer-school-course-descriptions) and [KLPT algorithm podcast](https://www.cryptography.fm/21))
9. L. Panny (2021), [Meet-in-the-middle and van Oorschot-Wiener applied to isogeny graphs](https://yx7.cc/docs/misc/isogprob_bristol_notes.pdf) 
