...
* **Commutative Supersingular Isogeny Diffie–Hellman (CSIDH;pronounce "sea-side"):** It was introduced by [W. Castryck, T. Lange, C. Martindale, L. Panny, and J. Renes](https://eprint.iacr.org/2018/383) in 2018. This is an efficient variant of the [Couveignes-Rostovtsev–Stolbunov (CRS) scheme](https://eprint.iacr.org/2006/145) for which a [subexponential attack](https://arxiv.org/abs/1012.4019) is possible using the quantum algorithms by [G. Kuperberg](https://arxiv.org/abs/quant-ph/0302112) and [O. Regev](https://arxiv.org/abs/quant-ph/0406151) from 2004.
  * **SeaSign:**
