...
{% include base_path %}
Following are some of the books that I would recommend reading (hopefully people would be able to find them in libraries since many of them are out-of-print) :
...
* **Mirror Symmetry and Algebraic Geometry** by *David A. Cox and Sheldon Katz*: Standard reference for learning about Gromov-Witten Invariants (chapter 7). Not an easy read. 
  * **Algebraic Geometry** by *A. Gathmann*: A gentle introduction to algebraic geometry with lots of computational exercises. There are many editions available, but I have read only the [2002 edition](https://www.mathematik.uni-kl.de/~gathmann/class/alggeom-2002/alggeom-2002.pdf).
