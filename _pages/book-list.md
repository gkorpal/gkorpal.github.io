...
* **An Invitation to Algebraic Geometry** by *Karen E. Smith, et. al.*: This book nicely complements the first chapter of Hartshorne (rest of that book is about scheme theory). Lots of solved examples. Note that, "genus" of a curve (Riemann surface) is defined in algebraic topology via Euler charateristic and in (complex) algebraic geometry via Riemann-Roch theorem. However, there is a close correspondence between "divisors" (algebraic geometry) and holomorphic "line bundles" (algebriac topology) on a Riemann surface. You can find more about this in chapter 4 of Hirzebruch's "Topological Methods in Algebraic Geometry" where Hodge decomposition is used ([related discussion](https://math.stackexchange.com/questions/544342/)).
...
* **Elementary Methods in Number Theory** by *M. B. Nathanson*: The part 3 of this book gives a good introduction to additive number theory. I haven't spent much time on this book since I don't enjoy thinking about combinatorial problems.
...
* **The Arithmetic of Elliptic Curves** by *J. H. Silverman*: The standard introductory text about elliptic curves using techniques from algebraic geometry (varieties in projective spaces). Make sure to use the 2nd edition corrected in 2016 printing, since earlier versions have lot of typos.
