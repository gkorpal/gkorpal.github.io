...
* **Lebesgue Integration On Euclidean Space** by *Frank Jones*: An introductory text on mesaure theory and fourier analysis. If you find this book boring/easy, spend some time on the first three chapters of Folland's book "Real Analysis: Modern Techniques and Their Applications".
* **Complex Analysis** by *Bak and Newman*: A comprehensive introduction to complex analysis where we study things like holomorphic functions (Fundamental theorem of Algebra), contour integration (Residue theorem), Mobius tranformation etc. This book also contains a brand new proof of prime number theorem. For a more gentle introduction, see the book by Sasane and Sasane, "A Friendly Approach to Complex Analysis".
