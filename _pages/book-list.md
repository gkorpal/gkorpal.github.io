...
* **Rational Points on Varieties** by *B. Poonen*: It provides a good introduction to the theory of Brauer groups and the Brauer-Manin obstruction, while briefly discussing other useful tools like étale cohomology. *In progress.*
  * **Algebraic Geometry and Arithmetic Curves** by *Q. Liu* (translated from the French by R. Erné): An introduction to the language of schemes (chapters 2 to 7), without assuming the base field to be algebraically closed, or of characteristic zero.
