...
* **Complex Analysis** by *Bak and Newman*: A comprehensive introduction to complex analysis (also contains a brand new proof of prime number theorem). For a more gentle introduction, see the book by Sasane and Sasane, "A Friendly Approach to Complex Analysis".
