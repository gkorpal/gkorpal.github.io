...
* **Rational Points on Varieties** by *B. Poonen*: It provides a good introduction to the theory of Brauer groups and the Brauer-Manin obstruction, while briefly discussing other useful tools like étale cohomology. *In progress.*
  * **Algebra** by *L. C. Grove*: The chapter V, "Structure of Rings and Algebras", might be useful for understanding the characterization of Azumaya algebras discussed by Poonen in section 1.5.1. A more detailed discussion is available in chapter IV of Milne's [Class Field Theory notes](https://www.jmilne.org/math/CourseNotes/cft.html).
