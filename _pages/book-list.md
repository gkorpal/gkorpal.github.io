...
* **Introduction to Algorithms** by *T. H. Cormen, C. E. Leiserson, R. L. Rivest, and C. Stein*: This is the standard textbook for learning about algorithms, contains both basic and advanced topics. One major take away would be to learn to write [pseudocode for algorithms](https://en.wikibooks.org/wiki/LaTeX/Algorithms). 
    * **Problem Solving with Algorithms and Data Structures using Python** by *B. M. Miller* and *D. L. Ranum*:  This is an introductory text on algorithms which uses Python 3.2 ([2nd edition](https://fbeedle.com/our-books/10-problem-solving-with-algorithms-and-data-structures-using-python-2nd-ed-9781590282571.html)) for illustrating concepts, helpful for leraning to translate the pseudocode to an actual programming language. This book is also [available online](https://runestone.academy/runestone/books/published/pythonds/index.html), however you will need to use an adblocker or [host it yourself](https://github.com/RunestoneInteractive/pythonds). 
