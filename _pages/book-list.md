...
* **Notes on p-adic Hodge Theory** by *O. Brinon and B. Conrad*: The notes are still in preliminary stage and are [available online](http://math.stanford.edu/~conrad/papers/notes.pdf). Note that the Theorem 1.1.1 stated in the first "Motivation" section of these notes is the Néron-Ogg-Shafarevich criterion and a good reference for that is the Chapter VII of Silverman's "The Arithmetic of Elliptic Curves."  *In progress.*
