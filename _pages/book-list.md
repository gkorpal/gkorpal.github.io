...
* **Rational Points on Varieties** by *B. Poonen*: It provides a good introduction to the theory of obstructions to rational points on a variety, while briefly discussing other useful tools like étale cohomology. *In progress.*
  * **Central Simple Algebras and Galois Cohomology** by *P. Gille and T. Szamuely*: Discusses the proofs and exercises given in the first chapter of Ponnen's book. A detailed discussion of examples related of class field theory is available in chapter II and IV of Milne's [Class Field Theory notes](https://www.jmilne.org/math/CourseNotes/cft.html).
