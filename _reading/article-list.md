...
My knowledge of applied maths is limited to the applications of number theory to cryptography. Note that the key cryptography results are generally announced in conferences supported by IACR ([CRYPTO (US)](https://link.springer.com/conference/crypto), [EUROCRYPT](https://link.springer.com/conference/eurocrypt), [ASIACRYPT](https://link.springer.com/conference/asiacrypt), [AFRICACRYPT](https://link.springer.com/conference/africacrypt), [LATINCRYPT](https://link.springer.com/conference/latincrypt), [PKC](https://link.springer.com/conference/pkc), [CHES](https://tches.iacr.org/), [FSE](https://www.iacr.org/transactions/tosc/)), IEEE ([FOCS](http://ieee-focs.org/), [ARITH](https://www.arithsymposium.org/)), ACM ([STOC](http://acm-stoc.org/)), and other independent events like [PQCrypto](https://link.springer.com/conference/pqcrypto), [WAIFI](https://link.springer.com/conference/waifi), [SAC](https://link.springer.com/conference/sacrypt), [ANTS](https://antsmath.org/), [AGC2T](https://bookstore.ams.org/conm-770/), and [NuTMiC](https://link.springer.com/book/10.1007/978-3-031-82380-0). On the other hand, key security and privacy results are generally announced in conferences supported IEEE ([S&P (Oakland)](https://www.ieee-security.org/TC/SP-Index.html), [EuroS&P](https://ieeexplore.ieee.org/xpl/conhome/1813044/all-proceedings)), ACM ([CCS](https://www.sigsac.org/ccs.html), [AsiaCCS](http://jianying.space/asiaccs/)), USENIX ([Security](https://www.usenix.org/conferences/byname/108)), and other independent events like [NDSS](https://www.ndss-symposium.org/), [PETS](https://petsymposium.org/), [CANS](https://link.springer.com/conference/cans), [ACNS](https://link.springer.com/conference/acns), [IWSEC](https://link.springer.com/conference/iwsec), and [ICISC](https://link.springer.com/book/10.1007/978-981-96-5566-3). A more comprehensive list of relevant conferences can be found [here](https://sec-deadlines.github.io/).

* D. F. Aranha, A. B. Hansen, and T. K. T. Mogensen, LINE-Break: Cryptanalysis and Reverse Engineering of Letter Sealing, _AsiaCCS 2026_. [Stable URL](https://linebreak.info/)
* G. K. Gegenhuber, P. Frenzel, M. Gunther, J. Ullrich, and A. Judmayer, Hey there! You are using WhatsApp: Enumerating Three Billion Accounts for Security and Privacy, _NDSS 2026_. doi: [10.14722/ndss.2026.230805](https://www.ndss-symposium.org/ndss-paper/hey-there-you-are-using-whatsapp-enumerating-three-billion-accounts-for-security-and-privacy/), [Stable URL](https://github.com/sbaresearch/whatsapp-census)
...
* L. Wouters, B. Gierlichs, and B. Preneel, My other car is your car: compromising the Tesla Model X keyless entry system, _IACR Trans. CHES_, (2021) no. 4, 149--172. doi:[10.46586/tches.v2021.i4.149-172](https://doi.org/10.46586/tches.v2021.i4.149-172)
