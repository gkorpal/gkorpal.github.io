...
* **Introduction to the Theory of Computation** by *M. Sipser*:  This is an introductory text on automata theory, computability theory, and complexity theory. Full course details are available via [MIT OCW](https://ocw.mit.edu/courses/mathematics/18-404j-theory-of-computation-fall-2020/index.htm) (also [YouTube](https://www.youtube.com/playlist?list=PLUl4u3cNGP60_JNv2MmK3wkOt9syvfQWY)). 
