...
* **Etale Cohomology and the Weil Conjecture** by *E. Freitag and R. Kiehl* (translated from the German by B. S. Waterhouse and W. C. Waterhouse): The only book I am aware of which discusses Deligne's proof. Also look at the lecture notes by [Katz](https://swc-math.github.io/aws/2000/00KatzN.pdf), [Milne](https://www.jmilne.org/math/CourseNotes/lec.html) and [Szamuely](http://pagine.dm.unipi.it/tamas/Weil.pdf). ([Math.SE](https://math.stackexchange.com/a/241876/))
  * **Algebraic Geometry** by *B. Edixhoven, D. Holmes, A. Kret, and L. Taelman*: These [lecture notes](/files/EdixhovenAGnotes.pdf) discuss Weil’s proof of the Riemann Hypothesis for curves over finite fields using intersection theory on surfaces. No etale cohomology needed.  Also see the notes by [Hansen](/files/hansen_curves-over-finite-fields.pdf).
