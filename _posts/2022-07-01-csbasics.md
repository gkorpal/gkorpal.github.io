...
- dipping my toes into [competitive programming](https://en.wikipedia.org/wiki/Competitive_programming) by solving problems from [Advent of Code](https://adventofcode.com/) and C++ based Online Judges (eg. [UVa](https://onlinejudge.org/), [Kattis](https://open.kattis.com/), [Codeforces](https://codeforces.com/), [Sphere](https://www.spoj.com/), [AtCoder](https://atcoder.jp/), [Timus](https://acm.timus.ru/), [DMOJ](https://dmoj.ca/), ...).
...
Eventually, I would also like to learn Rust, and participate in [Capture The Flag (CTF)](https://ctftime.org/) competitions like [CrytoHack](https://cryptohack.org/), [RootMe](https://www.root-me.org/?lang=en), [TryHackMe](https://tryhackme.com/) and [HackTheBox](https://www.hackthebox.com/) (Kali Linux).
