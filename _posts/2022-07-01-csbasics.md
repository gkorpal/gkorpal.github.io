...
- dipping my toes into C++ [competitive programming](https://en.wikipedia.org/wiki/Competitive_programming) by solving problems from [Advent of Code](https://adventofcode.com/) and Online Judges (eg. [UVa](https://onlinejudge.org/), [Kattis](https://open.kattis.com/), [Codeforces](https://codeforces.com/), [Sphere](https://www.spoj.com/), [AtCoder](https://atcoder.jp/), [Timus](https://acm.timus.ru/), [DMOJ](https://dmoj.ca/), ...).
