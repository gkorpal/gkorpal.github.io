...
Eventually, I would also like to learn Rust, and participate in Capture The Flag (CTF) competitions like [CrytoHack](https://cryptohack.org/), [RootMe](https://www.root-me.org/?lang=en), [TryHackMe](https://tryhackme.com/) and [HackTheBox](https://www.hackthebox.com/) (Kali Linux).
