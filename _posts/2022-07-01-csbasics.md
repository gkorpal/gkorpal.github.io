...
- dipping my toes into [competitive programming](https://en.wikipedia.org/wiki/Competitive_programming) by solving problems from [Advent of Code](https://adventofcode.com/), [AtCoder](https://atcoder.jp/), and [Codeforces](https://codeforces.com/).
