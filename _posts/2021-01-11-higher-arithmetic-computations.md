...
| C++ | [ASurfExt](https://gitlab.inria.fr/lbuse/ASurfExt), [castle](https://tthsqe12.github.io/castle.html), [CoCoALib](https://cocoa.dima.unige.it/cocoa/cocoalib/), [fplll](https://github.com/fplll), [GiNaC](https://www.ginac.de/), [HECKE](https://wstein.org/Tables/hecke-cpp.html), [LiDIA](https://github.com/mkoeppe/LiDIA), [NTL](https://libntl.org/), [polymake](https://polymake.org/doku.php/callable), [SymbolicC++](https://issc.uj.ac.za/symbolic/symbolic.html), [SymEngine](https://github.com/symengine/symengine)|
