...
|Magma | [Structural computations](http://magma.maths.usyd.edu.au/magma/overview/2/19/1/#subsection_1_1) (specialized CAS for mathematical structures from abstract algebra, algebraic geometry and  finite incidence geometry) |  OSCAR (GAP + Polymake + Singular + Antic (Hecke/Nemo)) | [SageMath](https://doc.sagemath.org/html/en/reference/spkg/) (CyPari2, fpylll, PySingular, JuPyMake, sagetex, ...)  |
...
| ------------| -------------------- |
| C | [Pari](https://pari.math.u-bordeaux.fr/), [FLINT](https://flintlib.org/), [Symmetrica](https://www.algorithm.uni-bayreuth.de/en/research/SYMMETRICA/)|
| C++ | [SymbolicC++](https://issc.uj.ac.za/symbolic/symbolic.html), [GiNaC](https://www.ginac.de/), [SymEngine](https://github.com/symengine/symengine), [NTL](https://libntl.org/), [CoCoALib](https://cocoa.dima.unige.it/cocoa/cocoalib/)|
| Haskell |  [DoCon](https://homepages.inf.ed.ac.uk/wadler/realworld/docon2.html) |
| Python | [SymPy](https://www.sympy.org/en/index.html) | 
| Julia | [Symbolics](https://github.com/JuliaSymbolics/Symbolics.jl), [Nemo](https://www.nemocas.org/) (FLINT wrapper) |
