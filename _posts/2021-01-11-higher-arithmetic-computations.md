...
| ------------| -------------------- |
| C | [CM (with fastECPP)](https://gitlab.inria.fr/enge/cm), [CMH](https://gitlab.inria.fr/cmh/cmh), [ecm](https://gitlab.inria.fr/zimmerma/ecm), [FLINT](https://flintlib.org/) ([Arb](https://arblib.org/) + [Antic](https://github.com/flintlib/antic) + [Calcium](https://fredrikj.net/calcium/)), [IML](https://cs.uwaterloo.ca/~astorjoh/iml.html), [Msieve](https://sourceforge.net/projects/msieve/), [PARI](https://pari.math.u-bordeaux.fr/), [SIMATH](https://github.com/GunterMueller/SiMATH), [Symmetrica](https://www.algorithm.uni-bayreuth.de/en/research/SYMMETRICA/), [zn_poly](https://web.maths.unsw.edu.au/~davidharvey/code/zn_poly/)|
