...
|SAS/SPSS | Statistical computations | R | [statsmodels](https://www.statsmodels.org/stable/index.html) (pandas + Patsy + Seaborn + ...)|
...
|Magma ([Cayley](https://mathshistory.st-andrews.ac.uk/HistTopics/CGT_history/) + [KANT V4](https://web.archive.org/web/20120223154242/https://page.math.tu-berlin.de/~kant/kash.html)) | [Structural computations](http://magma.maths.usyd.edu.au/magma/overview/2/19/1/#subsection_1_1) (specialized CAS for mathematical structures from abstract algebra, algebraic geometry, and  finite incidence geometry) |  OSCAR (GAP + Nemo + Polymake + Singular) | [SageMath](https://doc.sagemath.org/html/en/reference/spkg/) (CyPari2 + JuPyMake + PySingular + Pynac + SymEngine.py + fpylll + sagetex + ...)  |

For a more up-to-date information, have a look at the [ICMS proceedings](https://icms-conference.org/) and [swMATH](https://zbmath.org/software/).
...
| ------------| -------------------- |
| C | [CMH](https://gitlab.inria.fr/cmh/cmh#cmh-computation-of-genus-2-class-polynomials), [FLINT](https://flintlib.org/) ([Arb](https://arblib.org/) + [Antic](https://github.com/flintlib/antic) + [Calcium](https://fredrikj.net/calcium/)), [IML](https://cs.uwaterloo.ca/~astorjoh/iml.html), [PARI](https://pari.math.u-bordeaux.fr/), [SIMATH](https://github.com/GunterMueller/SiMATH), [Symmetrica](https://www.algorithm.uni-bayreuth.de/en/research/SYMMETRICA/), [zn_poly](https://web.maths.unsw.edu.au/~davidharvey/code/zn_poly/)|
| C++ | [ASurfExt](https://gitlab.inria.fr/lbuse/ASurfExt), [castle](https://tthsqe12.github.io/castle.html), [CoCoALib](https://cocoa.dima.unige.it/cocoa/cocoalib/), [eclib](http://homepages.warwick.ac.uk/staff/J.E.Cremona/mwrank/), [fplll](https://github.com/fplll), [gf2x](https://gitlab.inria.fr/gf2x/gf2x), [GiNaC](https://www.ginac.de/), [Givaro](https://casys.gricad-pages.univ-grenoble-alpes.fr/givaro/), [HECKE](https://wstein.org/Tables/hecke-cpp.html), [LiDIA](https://github.com/mkoeppe/LiDIA), [LinBox](https://linalg.org/), [NTL](https://libntl.org/), [polymake](https://polymake.org/doku.php/callable), [SymbolicC++](https://issc.uj.ac.za/symbolic/symbolic.html), [SymEngine](https://github.com/symengine/symengine)|
