...
However, closed-source projects tend to die in a decade or two (see the comments by [Tim Daly](https://web.archive.org/web/20230302162018/https://sites.math.rutgers.edu/~zeilberg/fb26.html)). For more up-to-date information, checkout [ICMS](https://icms-conference.org/), [JSS](https://www.jstatsoft.org/index), [SIGSAM](https://www.sigsam.org/Resources/ConferenceSeries.html), and [swMATH](https://zbmath.org/software/).
