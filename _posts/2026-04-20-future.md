...
As a mathematician, I also feel the pressure mounting. For example, celebrated mathematicians like [Terence Tao](https://terrytao.wordpress.com/2026/03/29/mathematical-methods-and-human-thought-in-the-age-of-ai/), [Jordan Ellenberg](https://www.math.wisc.edu/2023/12/08/jordan-ellenbergs-funsearch/), and [Ken Ono](https://epochai.substack.com/p/ai-can-now-do-math-but-can-it-ask) have jumped headfirst into AI-assisted theorem proving using Lean formalization. However, history suggest this maybe an evolution rather tan an end. Chess engines became training grounds for chess players instead of killing the sport. Similarly, it will be interesting to see the impact of [AI agents](https://blog.google/innovation-and-ai/models-and-research/google-deepmind/ai-for-math/) on mathematics competitions and research.
