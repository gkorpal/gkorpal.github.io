...
Note that Magma supports only on the old-school procedural programming paradigm, unlike Python (and SageMath) which also supports the modern object-oriented programming paradigm ([details](https://hackr.io/blog/programming-paradigms)).
