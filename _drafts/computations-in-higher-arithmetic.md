...
|Mathematica/Maple ([Macsyma](https://en.wikipedia.org/wiki/Macsyma))| Symbolic computations/General purpose CAS (UG level maths) | Maxima/FriCAS (fork of Axiom)/Yacas  | SymPy (NumPy + Matplotlib + mpmath + ...)|
