...
During this one year journey, I got the opportunity to practice programming in Racket ([Beginning Student Language](https://github.com/gkorpal/HtDP)), C ([Software Router](https://github.com/gkorpal/SoftwareRouter) and [TLS VPN](https://github.com/gkorpal/TLS-VPN)), and Python3 ([Jack compiler](https://github.com/gkorpal/Nand2Tetris)).
